...
const s = StyleSheet.create({ hero: { height: 320, margin: 12, borderRadius: 28, overflow: 'hidden', justifyContent: 'space-between', shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.14, shadowRadius: 24, elevation: 5 }, heroBottom: { padding: 22, alignItems: 'flex-end', gap: 7 }, heroLocation: { color: 'rgba(255,255,255,.82)', fontSize: 12, textAlign: 'right' }, nameRow: { flexDirection: 'row-reverse', alignItems: 'center', gap: 8 }, name: { color: c.onPhoto, fontSize: 38, fontWeight: '800', letterSpacing: -0.7 }, verified: { width: 21, height: 21, borderRadius: 11, backgroundColor: '#0A84FF', alignItems: 'center', justifyContent: 'center' }, stats: { flexDirection: 'row-reverse', paddingVertical: 15, borderRadius: 18, backgroundColor: c.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: c.line }, stat: { flex: 1, alignItems: 'center', gap: 6 }, value: { color: c.text, fontSize: 26, fontWeight: '700' }, menuRow: { paddingVertical: 14, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: c.line }, liveMenuRow: { paddingVertical: 13, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: c.line, flexDirection: 'row-reverse', alignItems: 'center', gap: 12 }, menuPhoto: { width: 68, height: 68, borderRadius: 15 }, menuPhotoEmpty: { width: 68, height: 68, borderRadius: 15, backgroundColor: c.cream, alignItems: 'center', justifyContent: 'center' }, categoryTitle: { color: c.text, fontSize: 18, fontWeight: '700', textAlign: 'right' }, itemTitleRow: { flexDirection: 'row-reverse', alignItems: 'center', gap: 8 }, menuName: { color: c.text, textAlign: 'right', fontSize: 16, fontWeight: '600', flexShrink: 1 }, price: { color: c.accent, fontSize: 14, fontWeight: '800', textAlign: 'right' }, soldOut: { color: c.danger, fontSize: 9, backgroundColor: '#FCE9E8', paddingHorizontal: 7, paddingVertical: 3, borderRadius: 9 }, unavailable: { opacity: 0.58 }, error: { color: c.danger, textAlign: 'center', padding: 20 }, placeTitle: { color: c.text, fontSize: 17, fontWeight: '700', textAlign: 'right' }, dayLabel: { color: c.text, fontSize: 12, fontWeight: '700' }, dayValue: { color: c.muted, fontSize: 12 }, });
