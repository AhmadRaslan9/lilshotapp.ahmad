...
const s = StyleSheet.create({
  page: { flex: 1, backgroundColor: c.bg }, content: { width: '100%', maxWidth: 480, alignSelf: 'center', padding: 22, paddingBottom: 48, gap: 15 }, brand: { flexDirection: 'row-reverse', justifyContent: 'center', alignItems: 'center', gap: 9 }, logo: { width: 46, height: 46, borderRadius: 16, backgroundColor: c.dark, alignItems: 'center', justifyContent: 'center' }, wordmark: { color: c.text, fontSize: 25, fontWeight: '800' }, title: { color: c.text, fontSize: 32, lineHeight: 43, fontWeight: '800', textAlign: 'right', letterSpacing: -.5 }, subtitle: { color: c.muted, textAlign: 'right', lineHeight: 22 }, card: { padding: 18, borderRadius: 22, backgroundColor: c.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: c.line, gap: 9 }, label: { color: c.text, fontSize: 12, fontWeight: '700', textAlign: 'right' }, input: { minHeight: 52, borderRadius: 14, backgroundColor: c.raised, borderWidth: StyleSheet.hairlineWidth, borderColor: c.line, color: c.text, paddingHorizontal: 16 }, section: { color: c.text, fontSize: 16, fontWeight: '700', textAlign: 'right' }, option: { minHeight: 78, padding: 16, borderRadius: 18, backgroundColor: c.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: c.line, flexDirection: 'row-reverse', alignItems: 'center', gap: 13 }, selected: { backgroundColor: c.dark, borderColor: c.dark }, optionTitle: { color: c.text, fontSize: 15, fontWeight: '700', textAlign: 'right' }, optionText: { color: c.muted, fontSize: 11, textAlign: 'right', marginTop: 4 }, white: { color: c.onPhoto }, softWhite: { color: 'rgba(255,255,255,.72)' }, notice: { padding: 14, backgroundColor: c.cream, borderRadius: 16 }, noticeText: { color: c.accent, textAlign: 'right', fontSize: 11, lineHeight: 19 }, segment: { flexDirection: 'row-reverse', gap: 4, padding: 4, backgroundColor: c.raised, borderRadius: 15 }, segmentItem: { flex: 1, minHeight: 43, borderRadius: 12, justifyContent: 'center', alignItems: 'center' }, segmentText: { color: c.muted, fontWeight: '700' }, helper: { color: c.muted, textAlign: 'right', fontSize: 11, lineHeight: 19 }, error: { color: c.danger, textAlign: 'right', lineHeight: 21 }, logout: { alignItems: 'center', padding: 10 },
});
