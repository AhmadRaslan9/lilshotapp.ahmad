...
const s = StyleSheet.create({
  content: { paddingBottom: 60 }, cover: { height: 260, margin: 12, borderRadius: 28, overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.12, shadowRadius: 24, elevation: 4 }, back: { padding: 15, alignItems: 'flex-start' },
  body: { marginHorizontal: 12, paddingHorizontal: 18, paddingTop: 54, paddingBottom: 22, marginTop: -54, borderRadius: 28, backgroundColor: c.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: c.line, alignItems: 'center', gap: 11 }, avatar: { position: 'absolute', top: -48, width: 96, height: 96, borderRadius: 48, borderWidth: 4, borderColor: c.surface, backgroundColor: c.cream, alignItems: 'center', justifyContent: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 3 }, avatarPhoto: { width: 86, height: 86, borderRadius: 43 }, initial: { color: c.dark, fontSize: 35, fontWeight: '800' },
  nameRow: { flexDirection: 'row-reverse', alignItems: 'center', gap: 6 }, name: { color: c.text, fontSize: 30, fontWeight: '800', letterSpacing: -0.5 }, username: { color: c.accent, fontSize: 11, writingDirection: 'ltr' }, bio: { color: c.muted, fontSize: 13, lineHeight: 21, textAlign: 'center' }, accountType: { flexDirection: 'row-reverse', alignItems: 'center', gap: 6 },
  stats: { alignSelf: 'stretch', flexDirection: 'row-reverse', paddingVertical: 15, borderRadius: 18, backgroundColor: c.raised, borderWidth: StyleSheet.hairlineWidth, borderColor: c.line }, stat: { flex: 1, alignItems: 'center', gap: 4 }, statValue: { color: c.text, fontSize: 24, fontWeight: '700' }, statLabel: { color: c.muted, fontSize: 11 }, error: { color: c.danger, textAlign: 'center' },
  section: { alignSelf: 'stretch', gap: 15, marginTop: 12 }, post: { overflow: 'hidden', borderRadius: 22, backgroundColor: c.dark, borderWidth: StyleSheet.hairlineWidth, borderColor: c.line }, postImage: { height: 360, width: '100%' }, postBody: { padding: 16, gap: 8 }, caption: { color: c.onPhoto, fontSize: 16, fontWeight: '700', textAlign: 'right' }, likeCount: { flexDirection: 'row-reverse', alignItems: 'center', gap: 6 },
