...
export const previewCafes = [
  { id: 'demo-riwaq', name: 'رِواق', latin: 'RIWAQ COFFEE', city: 'الرياض', district: 'حطين', tag: 'قهوة مختصة', rating: '4.8', reviews: 124, followers: '1.2k', image: coffeePhotos.table, description: 'مساحة هادئة، ضوء طبيعي، وكوب يُحضّر على مهل.', menu: [{ name: 'فلات وايت', note: 'إسبريسو وحليب بقوام ناعم', price: 19 }, { name: 'قهوة مقطّرة', note: 'محصول اليوم · تحضير يدوي', price: 24 }, { name: 'ماتشا لاتيه', note: 'ماتشا يابانية مع الحليب', price: 26 }] },
  { id: 'demo-dhill', name: 'ظِل', latin: 'DHILL COFFEE', city: 'الرياض', district: 'الياسمين', tag: 'جلسات خارجية', rating: '4.6', reviews: 86, followers: '842', image: coffeePhotos.cup, description: 'قهوة الصباح وجلسة تحت الظل. خذ وقتك واستمتع باللحظة.', menu: [{ name: 'كابتشينو', note: 'إسبريسو ورغوة حليب', price: 18 }, { name: 'آيس لاتيه', note: 'بارد وعلى ذوقك', price: 22 }] },
  { id: 'demo-nawa', name: 'نواة', latin: 'NAWA ROASTERS', city: 'جدة', district: 'الروضة', tag: 'قهوة مختصة', rating: '4.9', reviews: 208, followers: '2.1k', image: coffeePhotos.pour, description: 'رحلة صغيرة من المحصول إلى الكوب، وتفاصيل تستحق لقطة.', menu: [{ name: 'إسبريسو', note: 'محصول موسمي', price: 14 }, { name: 'كولد برو', note: 'استخلاص بارد', price: 25 }] },
];
...
export function filterCafes(cafes, city, category, query) {
  return cafes.filter(c => c.city === city && (category === 'الكل' || c.tag === category) &&
    `${c.name} ${c.latin} ${c.district}`.toLowerCase().includes(query.trim().toLowerCase()));
}
